...
bool CCollisionManager::Init()
{
	...
	CreateProfile("Rope", ECollision_Channel::Rope, true, ECollision_Interaction::Ignore);
	CreateProfile("Potal", ECollision_Channel::Potal, true, ECollision_Interaction::Ignore);
	...
	CreateProfile("MonsterAttackRange", ECollision_Channel::MonsterAttackRange, true, ECollision_Interaction::Ignore);
	CreateProfile("Item", ECollision_Channel::Item, true, ECollision_Interaction::Ignore);
	CreateProfile("CardInteraction", ECollision_Channel::CardInteraction, true, ECollision_Interaction::Ignore);


	SetCollisionInteraction("Player", ECollision_Channel::Rope, ECollision_Interaction::Collision);
	SetCollisionInteraction("Player", ECollision_Channel::Potal, ECollision_Interaction::Collision);
	...
	SetCollisionInteraction("Player", ECollision_Channel::MonsterAttackRange, ECollision_Interaction::Collision);
	SetCollisionInteraction("Player", ECollision_Channel::Item, ECollision_Interaction::Collision);
	SetCollisionInteraction("Player", ECollision_Channel::CardInteraction, ECollision_Interaction::Collision);


	SetCollisionInteraction("Rope", ECollision_Channel::Player, ECollision_Interaction::Collision);
	SetCollisionInteraction("Potal", ECollision_Channel::Player, ECollision_Interaction::Collision);
	...
	SetCollisionInteraction("MonsterAttackRange", ECollision_Channel::Player, ECollision_Interaction::Collision);


	SetCollisionInteraction("Item", ECollision_Channel::Player, ECollision_Interaction::Collision);


	SetCollisionInteraction("CardInteraction", ECollision_Channel::Player, ECollision_Interaction::Collision);
