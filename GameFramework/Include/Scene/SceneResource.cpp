...
bool CSceneResource::AddAnimationFrame(const std::string& Name, const Vector2& Start, const Vector2& End, const Vector2& Pivot)
{
	return CResourceManager::GetInst()->AddAnimationFrame(Name, Start, End, Pivot);
}
...
bool CSceneResource::AddAnimationFrame(const std::string& Name, float PosX, float PosY, float SizeX, float SizeY, float PivotX, float PivotY)
{
	return CResourceManager::GetInst()->AddAnimationFrame(Name, PosX, PosY, SizeX, SizeY, PivotX, PivotY);
}
