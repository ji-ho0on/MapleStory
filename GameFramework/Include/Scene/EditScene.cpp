...
bool CEditScene::Init()
{
	...
	CInput::GetInst()->AddBindFunction<CEditScene>("W",
		Input_Type::Push, this, &CEditScene::MoveUp);
	CInput::GetInst()->AddBindFunction<CEditScene>("S",
		Input_Type::Push, this, &CEditScene::MoveDown);
	CInput::GetInst()->AddBindFunction<CEditScene>("D",
		Input_Type::Push, this, &CEditScene::MoveRight);
	CInput::GetInst()->AddBindFunction<CEditScene>("A",
	...
	CInput::GetInst()->AddBindFunction<CEditScene>("MouseLButton",
