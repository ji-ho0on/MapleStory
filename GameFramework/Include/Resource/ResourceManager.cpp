...
bool CResourceManager::AddAnimationFrame(const std::string& Name, const Vector2& Start, const Vector2& End, const Vector2& Pivot)
{
	return m_AnimationManager->AddAnimationFrame(Name, Start, End, Pivot);
}
...
bool CResourceManager::AddAnimationFrame(const std::string& Name, float PosX, float PosY, float SizeX, float SizeY, float PivotX, float PivotY)
{
	return m_AnimationManager->AddAnimationFrame(Name, PosX, PosY, SizeX, SizeY, PivotX, PivotY);
}
