...
public:
    ...
    void AddFrame(const Vector2& Start, const Vector2& End, const Vector2& Pivot);
    void AddFrame(float PosX, float PosY, float SizeX, float SizeY);
    void AddFrame(float PosX, float PosY, float SizeX, float SizeY, float PivotX, float PivotY);
};
