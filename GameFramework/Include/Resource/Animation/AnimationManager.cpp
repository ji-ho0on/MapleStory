...
bool CAnimationManager::AddAnimationFrame(const std::string& Name, const Vector2& Start, const Vector2& End, const Vector2& Pivot)
{
	CAnimationSequence* Sequence = FindAnimation(Name);
	...
	Sequence->AddFrame(Start, End, Pivot);
...
bool CAnimationManager::AddAnimationFrame(const std::string& Name, float PosX, float PosY, float SizeX, float SizeY, float PivotX, float PivotY)
{
	CAnimationSequence* Sequence = FindAnimation(Name);
	...
	Sequence->AddFrame(PosX, PosY, SizeX, SizeY, PivotX, PivotY);
